  ...
  return (
    <>
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <h1 className="text-5xl font-bold text-sc-text mb-4">Contact Us</h1>
        <p className="text-xl text-sc-text-muted mb-12 max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="bg-sc-card border border-sc-border rounded-lg p-8">
            <h2 className="text-xl font-bold text-sc-text mb-2">
              General Inquiries
            </h2>
            <p className="text-sc-text-muted mb-4">
              Questions, suggestions, or just want to talk candy.
            </p>
            <a
              href="mailto:hello@swedishcrave.com"
              className="text-sc-primary font-semibold hover:underline"
            >
